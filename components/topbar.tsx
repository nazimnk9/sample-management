...
export default function Topbar({
  ...
  /* Create Refs to track click outside */
          ...
          <div className="space-y-1">
            {menuItems.map((item) => (
              <button
                ...
                className={`w-full text-left px-4 py-2 rounded-lg transition-colors text-sm ${pathname === `/${item.id}` ? "bg-primary text-white" : "hover:bg-muted text-foreground"
                  }`}
              >
                {item.label}
              </button>
